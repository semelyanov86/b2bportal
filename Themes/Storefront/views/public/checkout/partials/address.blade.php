        ...
        <div class="personal-information clearfix">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('customer_email') ? 'has-error': '' }}">
                    ...
                    <input type="text" name="customer_email" class="form-control" id="customer-email" value="{{ $orderModel->customer_email ? $orderModel->customer_email : old('customer_email') }}">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('customer_phone') ? 'has-error': '' }}">
                    ...
                    <input type="text" name="customer_phone" class="form-control" id="customer-phone" value="{{ $orderModel->customer_phone ? $orderModel->customer_phone : old('customer_phone') }}">
